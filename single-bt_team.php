...
$fullwidth = isset($excitor_options['single_team_fullwidth'])&&$excitor_options['single_team_fullwidth'] ? 'fullwidth': 'container';
$sidebar_width = (int) isset($excitor_options['single_team_sidebar_width']) ?  $excitor_options['single_team_sidebar_width']: 3;
...
$single_team_titlebar = isset($excitor_options['single_team_titlebar']) ? $excitor_options['single_team_titlebar']: true;
if($single_team_titlebar) excitor_titlebar();
?>
