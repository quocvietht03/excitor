...
$fullwidth = isset($excitor_options['post_fullwidth'])&&$excitor_options['post_fullwidth'] ? 'fullwidth': 'container';
$sidebar_width = (int) isset($excitor_options['post_sidebar_width']) ?  $excitor_options['post_sidebar_width']: 3;
$sidebar_width_md = $sidebar_width + 1;
$post_navigation = isset($excitor_options['single_post_navigation']) ? $excitor_options['single_post_navigation']: true;
$author = isset($excitor_options['single_author']) ? $excitor_options['single_author']: true;
$comment = isset($excitor_options['single_comment']) ? $excitor_options['single_comment']: true;
...
$post_titlebar = isset($excitor_options['post_titlebar']) ? $excitor_options['post_titlebar']: true;
if($post_titlebar) excitor_titlebar();
			...
			<div class="row">
				...
				<div class="bt-content <?php echo esc_attr($content_class); ?>">
					...
					while ( have_posts() ) : the_post();
						...
						if($post_navigation) excitor_post_nav();
						
						$author_desc = get_the_author_meta('description');
						if($author && $author_desc) echo excitor_author_render();
