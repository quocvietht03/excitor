...
$fullwidth = isset($excitor_options['single_services_fullwidth'])&&$excitor_options['single_services_fullwidth'] ? 'fullwidth': 'container';
$sidebar_width = (int) isset($excitor_options['single_services_sidebar_width']) ?  $excitor_options['single_services_sidebar_width']: 3;
...
$single_services_titlebar = isset($excitor_options['single_services_titlebar']) ? $excitor_options['single_services_titlebar']: true;
if($single_services_titlebar) excitor_titlebar();
?>
