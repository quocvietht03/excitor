...
$manifest['id']                  = 'excitor';
$manifest['skin']                = 'main';
$manifest['name']                = esc_html__( 'Bearsthemes', 'excitor' );
$manifest['uri']                 = 'http://bearsthemespremium.com/theme/excitor/';
$manifest['description']         = esc_html__( 'WordPress Theme', 'excitor' );
