...
$fullwidth = isset($excitor_options['services_fullwidth'])&&$excitor_options['services_fullwidth'] ? 'fullwidth': 'container';
$sidebar_width = (int) isset($excitor_options['services_sidebar_width']) ?  $excitor_options['services_sidebar_width']: 3;
...
$services_titlebar = isset($excitor_options['services_titlebar']) ? $excitor_options['services_titlebar']: true;
if($services_titlebar) excitor_titlebar();
?>
