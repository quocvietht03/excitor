...
$post_title = isset($excitor_options['single_team_title']) ? $excitor_options['single_team_title']: false;
...
<article <?php post_class(); ?>>
	<div class="row">
		...
		<div class="col-md-6">
			...
			<div class="bt-info">
				<h4><?php esc_html_e('Information', 'excitor'); ?></h4>
				<ul>
			...
			<div class="bt-social">
				<h4><?php esc_html_e('Social', 'excitor'); ?></h4>
