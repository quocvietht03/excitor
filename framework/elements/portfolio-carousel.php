...
vc_map(array(
	'name' => esc_html__('Portfolio Carousel', 'excitor'),
    ...
    'params' => array(
		...
		array(
			'type' => 'dropdown',
			'heading' => esc_html__('Nav & Dots Style', 'excitor'),
			'param_name' => 'nav_dots',
			'value' => array(
				esc_html__('Default', 'excitor') => 'nav-dots-default',
				esc_html__('Style 1', 'excitor') => 'nav-dots-style1'
			),
			'group' => esc_html__('Owl Setting', 'excitor'),
			'description' => esc_html__('Select nav and dots style display in this element.', 'excitor')
		),
		array(
			'type' => 'dropdown',
