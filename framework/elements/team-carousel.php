...
vc_map(array(
	'name' => esc_html__('Team Carousel', 'excitor'),
    ...
    'params' => array(
		...
		array (
			...
			'description' => esc_html__('Note: By default, all your members will be displayed. If you want to narrow output, select category(s) above. Only selected categories will be displayed.', 'excitor')
		),
		array(
			'type' => 'textfield',
		...
		array(
			...
			'value' => 'thumbnail',
			'group' => esc_html__('Item Setting', 'excitor'),
			'description' => esc_html__('Enter image size. Example: thumbnail, medium, large, full or other sizes defined by current theme. Alternatively enter image size in pixels: 200x100 (Width x Height). Leave empty to use "thumbnail" size.', 'excitor'),
		),
		array(
			'type' => 'dropdown',
