...
vc_map(array(
	'name' => esc_html__('Fancy Box', 'excitor'),
	'base' => 'bt_fancy_box',
	...
	'params' => array(
		...
		array(
			'type' => 'textfield',
			'heading' => esc_html__('Content Space', 'excitor'),
			...
			'description' => esc_html__('Please, enter number with px space between content and icon in this element. Ex: 60px', 'excitor')
		),
		...
		array(
			'type' => 'dropdown',
			'heading' => esc_html__('Icon Style', 'excitor'),
			'param_name' => 'icon_style',
			'value' => array(
				esc_html__('None', 'excitor') => '',
				esc_html__('Square', 'excitor') => 'square',
				esc_html__('Rounded', 'excitor') => 'rounded',
				esc_html__('Circle', 'excitor') => 'circle'
			),
			'group' => esc_html__('Icon', 'excitor'),
			'description' => esc_html__('Select style icon in this elment.', 'excitor')
		),
		array(
			'type' => 'textfield',
			'heading' => esc_html__('Icon Size', 'excitor'),
			...
			'description' => esc_html__('Please, enter number size icon in this element. Ex: 60px', 'excitor')
		),
		array(
			'type' => 'textfield',
		...
		array(
			...
			'description' => esc_html__('Select border style icon in this elment.', 'excitor')
		),
		array(
			'type' => 'textfield',
			...
			'description' => esc_html__('Please, enter number with px border width icon in this element. Ex: 2px', 'excitor')
		),
		array(
			'type' => 'colorpicker',
			...
			'description' => esc_html__('Select border color icon in this element.', 'excitor')
		),
		array(
			'type' => 'textfield',
			'heading' => esc_html__('Space', 'excitor'),
			'param_name' => 'icon_space',
			'value' => '',
			'group' => esc_html__('Icon', 'excitor'),
			'description' => esc_html__('Please, enter number with px space between icon and content in this element. Ex: 30px', 'excitor')
		),
		array(
			'type' => 'textfield',
		...
		array(
			...
			'group' => esc_html__('Title', 'excitor'),
			'description' => esc_html__('Add custom link of the title in this element.', 'excitor')
		),
		array(
			'type' => 'textfield',
			'heading' => esc_html__('Font Size', 'excitor'),
		...
		array(
			...
			'value' => '',
			'group' => esc_html__('Title', 'excitor'),
			'description' => esc_html__('Please, enter number with px space between title and description in this element. Ex: 15px', 'excitor')
		),
		array(
			'type' => 'textarea_html',
			'heading' => esc_html__('Description', 'excitor'),
			'param_name' => 'content',
			'value' => '',
			'group' => esc_html__('Description', 'excitor'),
			'description' => esc_html__('Please, enter description in this element.', 'excitor')
		),
		array(
			'type' => 'textfield',
			'heading' => esc_html__('Font Size', 'excitor'),
			...
			'value' => '',
			'group' => esc_html__('Description', 'excitor'),
			'description' => esc_html__('Please, enter number  with px font size description in this element. Ex: 14px', 'excitor')
		),
		array(
			'type' => 'textfield',
			'heading' => esc_html__('Line Height', 'excitor'),
			...
			'value' => '',
			'group' => esc_html__('Description', 'excitor'),
			'description' => esc_html__('Please, enter number with px line height description in this element. Ex: 24px', 'excitor')
		),
		array(
			'type' => 'textfield',
			'heading' => esc_html__('Letter Spacing', 'excitor'),
			...
			'value' => '',
			'group' => esc_html__('Description', 'excitor'),
			'description' => esc_html__('Please, enter number with px letter spacing description in this element. Ex: 1px', 'excitor')
		),
		array(
			'type' => 'colorpicker',
			'heading' => esc_html__('Color', 'excitor'),
			...
			'value' => '',
			'group' => esc_html__('Description', 'excitor'),
			'description' => esc_html__('Select color description in this element.', 'excitor')
		),
		array(
			'type' => 'textfield',
			'heading' => esc_html__('Space', 'excitor'),
			...
			'value' => '',
			'group' => esc_html__('Description', 'excitor'),
			'description' => esc_html__('Please, enter number with px space between description and read more in this element. Ex: 15px', 'excitor')
		),
		array(
			'type' => 'vc_link',
			'heading' => esc_html__('URL (Link)', 'excitor'),
			'param_name' => 'link',
			'group' => esc_html__('Extra Link', 'excitor'),
			'description' => esc_html__('Add extra link in this element.', 'excitor')
		),
		array(
			'type' => 'textfield',
			'heading' => esc_html__('Font Size', 'excitor'),
			...
			'value' => '',
			'group' => esc_html__('Extra Link', 'excitor'),
			'description' => esc_html__('Please, enter number  with px font size extra link in this element. Ex: 14px', 'excitor')
		),
		array(
			'type' => 'textfield',
			'heading' => esc_html__('Line Height', 'excitor'),
			...
			'value' => '',
			'group' => esc_html__('Extra Link', 'excitor'),
			'description' => esc_html__('Please, enter number with px line height extra link in this element. Ex: 24px', 'excitor')
		),
		array(
			'type' => 'textfield',
			'heading' => esc_html__('Letter Spacing', 'excitor'),
			...
			'value' => '',
			'group' => esc_html__('Extra Link', 'excitor'),
			'description' => esc_html__('Please, enter number with px letter spacing extra link in this element. Ex: 1px', 'excitor')
		),
		array(
			'type' => 'colorpicker',
			'heading' => esc_html__('Color', 'excitor'),
			...
			'value' => '',
			'group' => esc_html__('Extra Link', 'excitor'),
			'description' => esc_html__('Select color extra link in this element.', 'excitor')
		),
		array(
			'type' => 'css_editor',
