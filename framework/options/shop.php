...
Redux::setSection( $opt_name, array(
	...
	'fields'           => array(
		...
		array(
			'id'       => 'shop_top_bar',
			'type'     => 'switch',
			'title'    => esc_html__( 'Enable Top Bar', 'excitor' ),
			'subtitle' => esc_html__( 'Turn on to show the top bar on the top.', 'excitor' ),
			'default'  => false
		),
		array(
			...
			'right'   => false,
			'left'   => false,
			'title'    => esc_html__( 'Top Bar Space', 'excitor' ),
			'subtitle' => esc_html__( 'Control the bottom margin the top bar.', 'excitor' ),
			'default'  => array(
				'margin-bottom' => '30px'
			),
		...
		array(
			...
			'type'          => 'slider',
			'title'         => esc_html__( 'Product Per Page', 'excitor' ),
			'subtitle'      => esc_html__( 'Controls the number of product on the page.', 'excitor' ),
			'default'       => 10,
			'min'           => 1,
			'step'          => 1,
			'max'           => 20,
		...
		array(
			...
			'type'          => 'slider',
			'title'         => esc_html__( 'Product Per Row', 'excitor' ),
			'subtitle'      => esc_html__( 'Controls the number of product on the row.', 'excitor' ),
			'default'       => 3,
			'min'           => 2,
			'step'          => 1,
			'max'           => 4,
...
Redux::setSection( $opt_name, array(
	'title'            => esc_html__( 'Single Product', 'excitor' ),
	'id'               => 'bt_product',
	'subsection'       => true,
	'fields'           => array(
		array(
