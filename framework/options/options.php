<?php
    ...
    $args = array(
        ...
        'menu_title'           => esc_html__( 'Theme Options', 'excitor' ),
        'page_title'           => esc_html__( 'Theme Options', 'excitor' ),
    ...
    $args['admin_bar_links'][] = array(
        //'id'    => 'redux-docs',
        'href'  => '#',
        'title' => esc_html__( 'Documentation', 'excitor' ),
    );

    $args['admin_bar_links'][] = array(
        //'id'    => 'redux-support',
        'href'  => '#',
        'title' => esc_html__( 'Support', 'excitor' ),
    );

    $args['admin_bar_links'][] = array(
        //'id'    => 'redux-extensions',
        'href'  => '#',
        'title' => esc_html__( 'Extensions', 'excitor' ),
    );

    // SOCIAL ICONS -> Setup custom links in the footer for quick links in your panel footer icons.
    $args['share_icons'][] = array(
        'url'   => '#',
        'title' => esc_html__('Visit us on GitHub', 'excitor'),
        'icon'  => 'el el-github'
        //'img'   => '', // You can use icon OR img. IMG needs to be a full URL.
    );
    $args['share_icons'][] = array(
        'url'   => '#',
        'title' => esc_html__('Like us on Facebook', 'excitor'),
        'icon'  => 'el el-facebook'
    );
    $args['share_icons'][] = array(
        'url'   => '#',
        'title' => esc_html__('Follow us on Twitter', 'excitor'),
        'icon'  => 'el el-twitter'
    );
    $args['share_icons'][] = array(
        'url'   => '#',
        'title' => esc_html__('Find us on LinkedIn', 'excitor'),
        'icon'  => 'el el-linkedin'
    );
    ...
    if ( ! isset( $args['global_variable'] ) || $args['global_variable'] !== false ) {
        ...
        $args['intro_text'] = '<p>'.esc_html__('Did you know that Redux sets a global variable for you? To access any of your saved options from within your code you can use your global variable:', 'excitor').' <strong>'.$v.'</strong></p>';
    } else {
        $args['intro_text'] = '<p>'.esc_html__('This text is displayed above the options panel. It isn\'t required, but more info is always better! The intro_text field accepts all HTML.', 'excitor').'</p>';
    }

    // Add content after the form.
    $args['footer_text'] = '<p>'.esc_html__('This text is displayed below the options panel. It isn\'t required, but more info is always better! The footer_text field accepts all HTML.', 'excitor').'</p>';
    ...
    $tabs = array(
        array(
            'id'      => 'redux-help-tab-1',
            'title'   => esc_html__( 'Theme Information 1', 'excitor' ),
            'content' => '<p>'.esc_html__( 'This is the tab content, HTML is allowed.', 'excitor' ).'</p>'
        ),
        array(
            'id'      => 'redux-help-tab-2',
            'title'   => esc_html__( 'Theme Information 2', 'excitor' ),
            'content' => '<p>'.esc_html__( 'This is the tab content, HTML is allowed.', 'excitor' ).'</p>'
        )
    );
    ...
    $content = '<p>'.esc_html__( 'This is the sidebar content, HTML is allowed.', 'excitor' ).'</p>';
    ...
    */
    ...
    if ( ! function_exists( 'dynamic_section' ) ) {
        function dynamic_section( $sections ) {
            //$sections = array();
            $sections[] = array(
                'title'  => esc_html__( 'Section via hook', 'excitor' ),
                'desc'   => '<p class="description">'.esc_html__( 'This is a section created by adding a filter to the sections array. Can be used by child themes to add/remove sections from the options.', 'excitor' ).'</p>',
