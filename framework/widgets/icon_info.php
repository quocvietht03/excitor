<?php
class excitor_Icon_Info_Widget extends WP_Widget {
    function __construct() {
        parent::__construct(
                'icon_info_widget', // Base ID
                esc_html__('Icon Info', 'excitor'), // Name
                array('description' => esc_html__('Icon Info Widget', 'excitor'),) // Args
        );
    }
    ...
    function form($instance) {
		...
		?>
		<p>
			<label for="<?php echo esc_url($this->get_field_id('font_icon')); ?>"><?php _e('Icon:', 'excitor');
		 ?></label>
		...
		<p>
			<label for="<?php echo esc_url($this->get_field_id('meta_info')); ?>"><?php _e('Text:', 'excitor');
		 ?></label>
 ...
 */
function excitor_register_icon_info_widget() {
    register_widget('excitor_Icon_Info_Widget');
}
add_action('widgets_init', 'excitor_register_icon_info_widget');
?>
