...
$fullwidth = isset($excitor_options['single_portolio_fullwidth'])&&$excitor_options['single_portolio_fullwidth'] ? 'fullwidth': 'container';
$sidebar_width = (int) isset($excitor_options['single_portolio_sidebar_width']) ?  $excitor_options['single_portolio_sidebar_width']: 3;
$sidebar_width_md = $sidebar_width + 1;
$related_post = isset($excitor_options['single_portfolio_related_post']) ? $excitor_options['single_portfolio_related_post']: true;
$related_post_label = isset($excitor_options['single_portfolio_related_post_label'])&&$excitor_options['single_portfolio_related_post_label'] ? $excitor_options['single_portfolio_related_post_label']: esc_html__('Portfolio Related', 'excitor');
$related_post_count = (int) isset($excitor_options['single_portfolio_related_post_count'])&&$excitor_options['single_portfolio_related_post_count'] ? $excitor_options['single_portfolio_related_post_count']: 3;
$related_post_per_row = (int) isset($excitor_options['single_portfolio_related_post_per_row'])&&$excitor_options['single_portfolio_related_post_per_row'] ? $excitor_options['single_portfolio_related_post_per_row']: 3;
...
$single_portfolio_titlebar = isset($excitor_options['single_portfolio_titlebar']) ? $excitor_options['single_portfolio_titlebar']: true;
if($single_portfolio_titlebar) excitor_titlebar();
?>
