...
$page_comment = (int) isset($excitor_options['page_comment']) ?  $excitor_options['page_comment']: 1;
$sidebar_width = (int) isset($excitor_options['sidebar_width']) ?  $excitor_options['sidebar_width']: 3;
