...
$fullwidth = isset($excitor_options['shop_fullwidth'])&&$excitor_options['shop_fullwidth'] ? 'fullwidth': 'container';
$sidebar_width = (int) isset($excitor_options['shop_sidebar_width']) ? $excitor_options['shop_sidebar_width']: 3;
$sidebar_width_md = $sidebar_width + 1;

$shop_top_bar = isset($excitor_options['shop_top_bar']) ? $excitor_options['shop_top_bar']: false;
$shop_product_per_row = (int) isset($excitor_options['shop_product_per_row']) ? $excitor_options['shop_product_per_row']: 3;
