...
$fullwidth = isset($excitor_options['product_fullwidth'])&&$excitor_options['product_fullwidth'] ? 'fullwidth': 'container';
$sidebar_width = (int) isset($excitor_options['product_sidebar_width']) ?  $excitor_options['product_sidebar_width']: 3;
