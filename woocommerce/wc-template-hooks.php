...
add_filter( 'loop_shop_per_page', 'excitor_loop_shop_per_page', 20 );
function excitor_loop_shop_per_page( $cols ) {
	global $excitor_options;
	$cols = (int) isset($excitor_options['shop_product_per_page']) ? $excitor_options['shop_product_per_page']: 10;
	return $cols;
}
