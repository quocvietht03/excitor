...
$fullwidth = isset($excitor_options['portfolio_fullwidth'])&&$excitor_options['portfolio_fullwidth'] ? 'fullwidth': 'container';
$columns = (int) isset($excitor_options['portfolio_columns']) ?  $excitor_options['portfolio_columns']: 1;
$sidebar_width = (int) isset($excitor_options['portfolio_sidebar_width']) ?  $excitor_options['portfolio_sidebar_width']: 3;
...
$portfolio_titlebar = isset($excitor_options['portfolio_titlebar']) ? $excitor_options['portfolio_titlebar']: true;
if($portfolio_titlebar) excitor_titlebar();
?>
