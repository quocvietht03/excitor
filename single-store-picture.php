...
$fullwidth = isset($excitor_options['single_store_picture_fullwidth'])&&$excitor_options['single_store_picture_fullwidth'] ? 'fullwidth': 'container';
$sidebar_width = (int) isset($excitor_options['single_store_picture_sidebar_width']) ?  $excitor_options['single_store_picture_sidebar_width']: 3;
...
$single_store_picture_titlebar = isset($excitor_options['single_store_picture_titlebar']) ? $excitor_options['single_store_picture_titlebar']: true;
if($single_store_picture_titlebar) excitor_titlebar();
?>
